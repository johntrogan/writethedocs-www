...
We're expecting to open ticket sales and the Opportunity Grant program within a few weeks.
...
Like last year we're also opening up a few talk slots for pre-recorded videos for remote speakers, so if you can't make it to {{city}} on {{ date.short }} you can still submit your proposal.
...
We encourage you to read the call carefully, to improve your chances of being accepted.
In particular, see our notes about AI-centered proposals.
...
with improvements based on sponsor feedback, and updated for this year's Berlin conference.
